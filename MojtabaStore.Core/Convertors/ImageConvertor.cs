...
namespace MojtabaStore.Core.Convertors
{
    public class ImageConvertor
    {
        public void Image_resize(string input_Image_Path, string output_Image_Path, int new_Width)
        {
            ...
            Bitmap new_DrawArea = new Bitmap(new_Width, new_Height);

            //</ create Empty Drawarea >



            using (Graphics graphic_of_DrawArea = Graphics.FromImage(new_DrawArea))

            {
                ...
                using (FileStream output = System.IO.File.Open(output_Image_Path, FileMode.Create))
